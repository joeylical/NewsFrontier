...
class AIPostProcessService:
    ...
    def reload_prompts(self):
        ...
        try:
            ...
            # Load prompts from settings, error if not found
            ...
            # Ensure all required prompts are loaded
            for prompt_type in self.prompts:
                if not self.prompts[prompt_type]:
            ...
            # Don't use fallback prompts, keep existing prompts or set to None
            # This will cause processing to fail gracefully until prompts are fixed
            raise e
    ...
    def create_summary(self, article: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            # Use prompt from database, error if not available
    ...
    def generate_user_daily_summary(self, user_id: int, username: str):
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Failed to generate cover image prompt for user {user_id}: {e}")
    ...
    def create_daily_summary_content(self, user_context: Dict) -> Optional[str]:
        ...
        try:
            ...
            if not system_prompt:
                raise ValueError("Daily summary system prompt not found in database")
    ...
    def generate_cover_image_prompt(self, summary_content: str) -> Optional[str]:
        ...
        try:
            ...
            if not cover_prompt_template:
                raise ValueError("Cover image generation prompt not found in database")
